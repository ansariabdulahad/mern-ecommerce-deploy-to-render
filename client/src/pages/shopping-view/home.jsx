...
const ShoppingHome = () => {
    ...
    // handle onclick events for current category
    ...
    // useEffect for automatic slides change animations
    useEffect(() => {
        ...
        <div className='flex flex-col min-h-screen'>
            ...
            <section className='py-12 bg-gray-50'>
                <div className='container mx-auto px-4'>
                    <h2 className='text-3xl font-bold text-center mb-8 capitalize'>Shop by category</h2>
            ...
            <section className='py-12 bg-slate-100'>
                <div className='container mx-auto px-4'>
                    <h2 className='text-3xl font-bold text-center mb-8 capitalize'>Shop by brands</h2>
            ...
            <section className='py-12 bg-violet-50'>
                <div className='container mx-auto px-4'>
                    <h2 className='text-3xl font-bold text-center mb-8 capitalize'>Feature products</h2>
